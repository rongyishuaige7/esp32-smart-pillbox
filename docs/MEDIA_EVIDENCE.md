...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype.jpg` | 2026-04-08 | 已移除 EXIF/GPS 及其他图片元数据；从副本缩放处理 | 历史智能药盒原型照片。 |
| `hardware/eda/schematic.pdf` | 2026-07-18 提供的导出文件 | 从副本移除 PDF 元数据 | 历史原理图导出。PIR、HX711、蜂鸣器和 RGB 引脚与当前源码映射一致，但原理图不证明实际装配或当前固件。 |
