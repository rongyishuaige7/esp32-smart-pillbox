...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype.jpg` | 2026-04-08 | EXIF/GPS and other image metadata removed; resized from a copy | Historical pillbox prototype photo. |
| `hardware/eda/schematic.pdf` | Export supplied 2026-07-18 | PDF metadata removed from a copy | Historical schematic export. PIR, HX711, buzzer and RGB pins match the current source map, but the schematic is not proof of the actual assembly or current firmware. |
